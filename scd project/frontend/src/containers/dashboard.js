...
const Dashboard = ({
    ...
    return (
        <div className='container mb-5 mt-5'                            style={{alignitems:'center', 
                                                                        maxWidth:'500px',
            ...
            <p className='mt-3 mb-3' style={{fontFamily:'Cold Warm by Chequered Ink'}}>
                Enter your credentials to create profile :</p>

        <form onSubmit={e => onSubmit(e)}                      style={{alignitems:'center' ,
                                                                maxWidth:'450px',padding: "10px", }}>
                <div className='form-group'>
                    <label className='form-label' htmlFor='first_name'
                                                                style={{fontFamily:'Cold Warm by Chequered Ink',fontSize:'25px'}}>
                        First Name</label>
                    <input
                ...
                <div className='form-group'>
                    <label className='form-label mt-3' htmlFor='phone'style={{fontFamily:'Cold Warm by Chequered Ink',fontSize:'25px'}}>
                        Phone</label>
                    <input
                        className='form-control'
                        type='text'
                ...
                <div className='form-group'>
                    <label className='form-label mt-3' htmlFor='address' style={{fontFamily:'Cold Warm by Chequered Ink',fontSize:'25px'}}>
                        Address</label>
                    <input
                        className='form-control'
                        type='text'
            ...
            <p className='mt-3'style={{fontFamily:'Cold Warm by Chequered Ink',textAlign:'center'}}>
            ...
            <a
                ...
                href='#!'
                onClick={del}
                style={{width:'90%',background:'lightred',borderColor:'lightred',
                padding:'10px', fontFamily:'Cold Warm by Chequered Ink',fontSize:'20px' ,
